...
<section id="video" class="relative bg-[oklch(0.88_0.19_95)] py-20 sm:py-28">
    ...
    <div class="relative mx-auto max-w-6xl px-5 sm:px-8">
        ...
        <div class="flex items-end justify-between gap-4">
            <div>
                <p class="font-poster text-xs uppercase tracking-[0.3em] text-ink/80"><?php echo esc_html($video_kicker); ?></p>
                <h2 class="mt-2 font-display text-5xl leading-[0.9] text-ink sm:text-7xl"><?php echo esc_html($video_title); ?></h2>
                <p class="mt-3 max-w-xl text-ink/90">
        ...
        <div class="relative mt-10">
            ...
            <div class="relative aspect-video w-full overflow-hidden rounded-3xl border-2 border-ink bg-ink" style="box-shadow: 10px 10px 0 var(--ink)">
                ...
                <div class="absolute inset-0 flex flex-col items-center justify-center gap-5 bg-[oklch(0.15_0.08_280/0.45)] text-center">
                    ...
                    <a href="<?php echo esc_url($link_youtube_video); ?>" target="_blank" rel="noreferrer" class="btn-pop btn-aqua"><?php echo esc_html($video_watch_button_label); ?></a>
                </div>
            </div>
        </div>
    </div>
